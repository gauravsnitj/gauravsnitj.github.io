...
<div align="center"> 
    ...
    <form action = "login.php" method = "post">
     ...
     <p>LOGIN INFORMATION</p><br/>
                  <p>UserName  :</p><input type = "text" name = "username" class = "box"/><br /><br />
                  <p>Password  :</p><input type = "password" name = "password" class = "box" /><br/><br />
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                  ...
                  <div class="row">
                        <div class="col-md-12">
                          <img class="img-responsive title-logo" src="assets/img/doctor_join_us.png" alt="mainpic">
                        </div>
                  </div>
                    ...
                    <div class="form ">
                      <div class="tab-content"> 
                        ...
                        <h2>Doctor's Form</h2>
                          ...
                          <form action="addDoctorDatabase.php" method="POST">
                          ...
                          <div class="top-row">
                            ...
                            <input type="tel" name="mobile_no" style="width:100%;" style="height:100%;" required autocomplete="off"/>
                          </div>
                        ...
                        <div class="top-row">
                          ...
                          <div class="field-wrap">
                            ...
                            <input type="text" name="specialization" style="width:100%;" style="height:100%;"required autocomplete="off"/>
                          </div>
                          ...
                          <div class="top-row">
                           ...
                           <div class="field-wrap">
                                ...
                                <div class="form_row">
                                    <label>Gender<span class="req">*</span>:
                                      ...
                                      <div class="top-row">
                                        <div class="field-wrap">
                                            ...
                                            <div class="gender">
                                              <input type="radio" name="gender" value="male" style="padding-left" /> Male <br />
                                    ...
                                    <!--
                                      <input type="radio" class="radio" name="gender" id="rdoGenderMale" value="male" required autocomplete="off"/>&nbsp;Male


                                    </label>
                                         <label for="rdoGenderFemale"><input type="radio" class="radio" name="gender" id="rdoGenderFemale" value="female" required autocomplete="off"/>&nbsp;Female
                                      -->
                           ...
                           <div class="field-wrap">
                            ...
                            <input type="number" name="experience"style="width:100%;" style="height:100%;" required autocomplete="off"/>
                          </div>
