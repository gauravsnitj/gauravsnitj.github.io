...
<tr>
<td>Sardana Labs</td>
<td>BMC Chowk, Jalandhar</td>
</tr>
<tr class="even">
<td>Ruby Path Labs</td>
<td>Adarsh Nagar,Jalandhar</td>

</tr>

<tr>
<td>Pathania Clinical Laboratory</td>
<td>Laxmi Pura,Jalandhar</td>
</tr>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
    <div class="col-md-12">
      <img class="img-responsive title-logo" src="assets/img/lab.jpg" alt="mainpic">
    </div>
  </div>
  ...
  <div class="row title-logo">
                      ...
                      <div class="col-md-8 title-logo">
                            <div class= "appointment">
                            
                                <div class="header text-center">
                                    <h2>FIND PATHOLODGY LABS</h2>
                                    <a  class="number">
                                       ...
                                       <!-- <div class="alert alert-success alert-dismissable">
                                            ...
                                            <button type="button" class="close" data-dismiss="alert"
                                             ...
                                             Success! Well done its submitted.
                                                   ...
                                                   <button type="button" class="btn btn-default btn-sm but-pad1"><a href="#infoScreen"> Submit</button>
