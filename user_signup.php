...
<head>
    ...
    <!-- script for pages which are not accessible without login -->
            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                 ...
                 <div class="row">
                        ...
                        <div class="col-lg-6 signup_body " >
                            ...
                            <div class="form">
                                  ...
                                  <div class="tab-content"> 
                                    <div id="signup">   
                                      ...
                                      <form action="userSignupDatabase.php" method="POST">
                                      ...
                                      <div class="top-row">
                                        <div class="field-wrap">
                                          ...
                                          <input name="first_name" style="width:100%;" style="height:100%;" type="text" required autocomplete="off" />
                                        </div>
                                        ...
                                        <div class="field-wrap">
                                          ...
                                          <input name="last_name" type="text"/ style="width:100%;" style="height:100%;">
                                        </div>
                                      </div>
                                      ...
                                      <div class="field-wrap">
                                        ...
                                        <input name="email" type="email" style="width:100%;" style="height:100%;"required autocomplete="off"/>
                                      </div>
                                ...
                                <div class="top-row">
                                    ...
                                    <div class="field-wrap ">
                                        <label class="user_age">
                                            
                                                Age<span class="req">*</span>
                                            
                                        </label>
                                        <input name="age" type="number" style="width:100%;" style="height:100%;" required autocomplete="off"/>
                                    </div>
                                    ...
                                    <div class="field-wrap">
                                        ...
                                        <input name="password" type="password"style="width:100%;" style="height:100%;"required autocomplete="off"/>
                                    </div>
