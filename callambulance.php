...
<form action = "login.php" method = "post">
    ...
    <div id="msgScreen"> <a href="#" class="cancel">&times;</a>

    <p>Please Wait Ambulance will reach you within 5 minutes!!!!</p> 
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                 ...
                 <div class="row">
                  <div class="col-md-12">
                         <img class="img-responsive title-logo" src="assets/img/mainpic.jpg" alt="mainpic">
                  </div>
                </div>
                                       ...
                                       <!-- <div class="alert alert-success alert-dismissable">
                                            ...
                                            <button type="button" class="close" data-dismiss="alert"
                                             ...
                                             Success! Well done its submitted.
                                                   ...
                                                   <p><button type="button" class="btn btn-default btn-sm but-pad"><a href="#msgScreen">Submit</button></a>
    	    
                                                  
                                        
                                        <!-- <input class="btn btn-primary send but-pad " " type="submit" value="Submit"/>-->
