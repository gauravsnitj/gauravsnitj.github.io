  				...
  				<div class="container-fluid">
				    ...
				    <div class="col-lg-6">
				    	<ul class="nav navbar-nav navbar-right">
							...
							<p style="color:white;"><b><?php echo "Hi ".$login_session; ?></b></p>
							</div>


							<div class="col-md-1 top-mar">
							<p><button type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-user"><a href="logout.php"></span>Log Out</button></a>
							</div>
					...
					<div class= "col-lg-3 col-sm-6 col-xs-12">
						<div class= "hservice">
							...
							<div class= "service-description text-center">
								...
								<p></p>
								<a href="joinus.php" class="rm-btn btn btn-primary">
										Read More <i class="fa fa-caret-right"></i></a>
							</div>
						</div>
						<div class="clearfix"></div>
